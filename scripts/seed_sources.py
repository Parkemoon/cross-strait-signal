...
SOURCES = [
    ...
    # Taiwan — blue (China Times targeted sections)
    {
        'name': 'CT Cross-Strait',
        'name_zh': '中時兩岸',
        'url': 'http://localhost:1200/chinatimes/chinese',
        'source_type': 'independent_media',
        'place': 'TW',
        'bias': 'blue',
        'language': 'zh-tw',
    ...
    },
    {
        'name': 'CT Politics',
        'name_zh': '中時政治',
        'url': 'http://localhost:1200/chinatimes/politic',
        'source_type': 'independent_media',
        'place': 'TW',
        'bias': 'blue',
        'language': 'zh-tw',
    ...
    },
    {
        'name': 'CT Military',
        'name_zh': '中時軍事',
        'url': 'http://localhost:1200/chinatimes/armament',
        'source_type': 'independent_media',
        'place': 'TW',
        'bias': 'blue',
        'language': 'zh-tw',
    ...
    },
    {
        'name': 'CT Opinion',
        'name_zh': '中時言論',
        'url': 'http://localhost:1200/chinatimes/opinion',
        'source_type': 'independent_media',
        'place': 'TW',
        'bias': 'blue',
        'language': 'zh-tw',
