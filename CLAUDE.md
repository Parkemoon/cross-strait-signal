...
**Topic taxonomy (18 categories)**: `MIL_EXERCISE`, `MIL_MOVEMENT`, `MIL_HARDWARE`, `DIP_STATEMENT`, `DIP_VISIT`, `DIP_SANCTIONS`, `PARTY_VISIT`, `ECON_TRADE`, `ECON_INVEST`, `POL_DOMESTIC_TW`, `POL_DOMESTIC_PRC`, `POL_TONGDU`, `INFO_WARFARE`, `LEGAL_GREY`, `HUMANITARIAN`, `TRANSPORT`, `INT_ORG`
