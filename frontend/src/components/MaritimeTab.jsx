...
import MaritimeCivilSection from "./MaritimeCivilSection";
...
// Guard tracker (Phase 2e); the second is the civilian-fleet + radar-only
// detection layer (Phase 2g) — the "militia / dredger" layer named after what
// GFW actually measures (coarse vessel class + Sentinel-1 detections).
  ...
  return (
    <main style={{ padding: "28px 32px", minWidth: 0 }}>
      <DocumentHeader
        ...
        meta={"AIS presence · CGA enforcement · radar detections"}
      />
      <CoastGuardSection />
      <MaritimeCivilSection />
    </main>
  );
}
