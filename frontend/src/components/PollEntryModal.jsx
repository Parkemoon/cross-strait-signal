...
// dropdowns / new-key form only offer valid choices. The picker shape +
// "create new" branches mirror PollReviewQueue.jsx for visual / mental
// consistency; manual entry is the third entry path (alongside AI
// extraction → review queue and backfill scripts) documented in
// database.md.
