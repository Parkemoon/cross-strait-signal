...
CREATE INDEX IF NOT EXISTS idx_diplo_tier        ON diplomacy_statements(authority_tier, approval_status);-- Alt-model comparison experiment (Chinese LLMs via OpenRouter).
...
-- ---- Coast Guard tracker (Phase 2e) — mirror of db/migrations/0008_coast_guard.sql ----
...
-- ---- CGA enforcement (Phase 2e Part B) — mirror of db/migrations/0009_cga_enforcement.sql ----
...
-- Cross-strait visits tracker (Phase 2f) — see db/migrations/0010_cross_strait_visits.sql
-- for the design note. Cross-strait scope only; pending → analyst queue.
...
-- ---- Maritime civilian-fleet + dark-vessel layer (Phase 2g) — mirror of db/migrations/0012_maritime_civil.sql ----
